class AppSignal(Exception):
    SIG_EXIT_SUCCESS = 100 # App is gracefully exiting as intended.
    ...
    SIG_APP_SUSPEND_SELF = 301 # App requests itself to be suspended.
    SIG_APP_SUSPEND = 302 # App requests another app to be suspended.
    SIG_APP_RESUME = 303 # App requests another app to be resumed.
    SIG_APP_CLOSE = 304 # App requests another app to be closed.
    SIG_APP_TERM = 305 # App requests another app to be terminated.
